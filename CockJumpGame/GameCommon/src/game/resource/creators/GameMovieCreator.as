package game.resource.creators {
	...
	public class GameMovieCreator
	{
		 ...
		 */
		public function GameMovieCreator (library :Library, juggler :Juggler = null) {
			_library = library;
		 ...
		 */
		public function createMovie (name :String, addToJuggler:Boolean = true) :Movie {
			var movie :Movie = _library.createMovie(name);
			movie.addEventListener(Event.ADDED_TO_STAGE,
